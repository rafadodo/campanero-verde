...
COLS_TABLA_BONOS = ['plazo', 'ticker', 'u']  # columnas a filtrar, donde la u es de ultimo precio

if __name__ == "__main__":
    with requests.Session() as s:
        s.headers['accept'] = 'application/json'
        user_name = input('bueno aver dame tu usuario: ')
        password = getpass('bien, y pasame la pass: ')        
        ...
        df_bonos = pd.DataFrame(bonos_soberanos.json()['cotizaciones'])[COLS_TABLA_BONOS]
